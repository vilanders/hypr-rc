...
if [ "$decision" = "y" ]; then
  ...
  sudo pacman -Syu hyprland rofi mpv kitty breeze waybar pavucontrol-qt hyprshot dunst thunar udiskie btop fastfetch zsh ttf-jetbrains-mono libreoffice-fresh flatpak git adw-gtk-theme gtk3 gtk4 qt6ct gtklock
